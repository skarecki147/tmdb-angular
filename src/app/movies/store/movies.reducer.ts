...
export const moviesFeature = createFeature({
    ...
    reducer: createReducer(
      initialState,
      // Movies API
      on(MoviesApiActions.fetchMovies, (_state) => ({..._state, loading: true})),
      ...
      // Movie Details API
      on(MoviesApiActions.fetchMovieDetails, (_state) => ({..._state})),
      on(MoviesApiActions.fetchMovieDetailsSuccess, (_state, {movie}) => ({
          ..._state,
          moviesDetails: {
